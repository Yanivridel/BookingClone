function PropertyFinePrint() {
  return (
    <div className="text-sm border-[1px] border-softGrayBorder p-4 rounded-[8px]">
      <p>
        {" "}
        Please note that the hotel is located in a limited parking zone. Guests
        plan to arrive by car they are kindly requested to contact the hotel for
        more information.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        When booking for four rooms or more, special reservation conditions may
        apply.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Please inform Aparthotel Stare Miasto of your expected arrival time in
      ...
      <br />
      <p>
        It's not possible to stay at this property for coronavirus (COVID-19)
        quarantine purposes.
      </p>
      <br />
      <p>
        When staying at the property with children, note that the property is
        legally obliged to apply standards for the protection of minors to
        determine the identity of the minors and their relationship with the
        adult they’re staying with.
      </p>
    </div>
  );
}
