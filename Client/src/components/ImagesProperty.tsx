                ...
                <Card className='w-[263px] h-[296px]'>
                    <div className='h-[20%] p-2 border-b-2 flex items-center justify-end'>
                        <div className='flex gap-1 '>
                            ...
                            <div className='flex gap-1 p-1  '>
                                <Badge variant="rating" className='cursor-pointer h-full'>{propertyData.rating.cleanliness}</Badge>
                            </div>
                        </div>
                    </div>
                    <div className='h-[60%] border-b-2 p-2 grid gap-2'>
                        ...
                        <div className=' grid justify-center'>
                            <div className='w-40 '>
                                <p className='text-xs'>“Check in and check out was very smooth. I arrived early and they got me a room earlier than check-in time when it became available. The porters...”</p>
                            </div>
                        </div>
                    ...
                    <div className='h-[20%] flex items-center justify-between p-2'>
                        <div><p className='font-bold'>Great location!</p></div>
                        <div><Badge variant="outline">8.9</Badge></div>
                    </div>
                </Card>
                <Card className='w-[261px] h-[155px] rounded-lg relative'>
                    <img src={KidsImage} alt="" className="w-full h-full object-cover rounded-lg" />
                    <Button className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-blue-500 text-white px-4 py-2 rounded-lg'>Show On Map</Button>
                </Card>
            </div>
        </div>
    )
