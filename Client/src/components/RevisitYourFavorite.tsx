...
const RevisitYourFavorite = () => {
  return (
    <div>
      <div className='flex items-center gap-5'>
        <div>
          <img src="https://t-cf.bstatic.com/design-assets/assets/v3.142.0/illustrations-traveller/TripsEmptyScreenComplete@2x.png" className='w-44 h-44' alt="" />
        </div>
