...
export async function generateVerificationCode(email: string): Promise<void> {
    try {
        ...
        <body style="font-family: Arial, sans-serif; padding: 20px; background-color: #f0f0f0;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td align="right" style="padding-right: 15px;">
                            <span style="font-size: 16px; color: white;">${email}</span>
                        </td>
                    </tr>
                </table>
            </header>
            <div style="background-color: white; border-radius: 8px; box-shadow: 0px 0px 15px rgba(0,0,0,0.1); margin-top: 30px; padding: 30px;">
            <h3 style="color: #003a63; font-size: 20px;">Email Verification and Account Login</h3>
            <p style="font-size: 16px; color: #333;">Hello,<br><br>This is your unique verification code for logging in to Booking.com. Please enter it within the next 5 minutes.</p>
            ...
            <p style="font-size: 14px; color: #333;">If you have any issues, please contact <a href="mailto:support@booking.com" style="color: #003a63;">support@booking.com</a>.</p>
            </div>
...
export async function verifyVerificationCode(email: string, enteredCode: string): Promise<boolean> {
    try {
